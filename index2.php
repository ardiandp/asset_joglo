...
<body class="container py-4">
    ...
    <!-- Edit Modal Form -->
    <div class="modal fade" id="edit-modal-form" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Kwitansi Pembayaran</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="edit.php" id="form-edit-nota">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-section">
                                    <h6><i class="fas fa-user-circle me-2"></i>Data Pelanggan</h6>
                            ...
                            <div class="col-md-6">
                                <div class="form-section">
                                    <h6><i class="fas fa-list me-2"></i>Kategori Transaksi</h6>
    ...
    <!-- Data Table -->
    <h2 class="mt-5 mb-3"><i class="fas fa-list me-2"></i>Daftar Transaksi</h2>
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    echo "<tr>
                        ...
                        <td>
                            ...
                            <button class='btn btn-sm btn-warning' onclick='editTransaksi({$data['id']})'>
    ...
    <script>
        ...
        const editModalForm = new bootstrap.Modal(document.getElementById('edit-modal-form'));
        ...
        // Show edit modal when edit button clicked
        function editTransaksi(id) {
            // Fetch data for the selected transaction and populate the form fields
            // For demonstration, assume data is fetched and populated
            editModalForm.show();
        }
        ...
        document.getElementById('btn-update').addEventListener('click', function() {
            const form = document.getElementById('form-edit-nota');
            if (form.checkValidity()) {
                form.submit();
            } else {
                form.reportValidity();
